	...
	<view>
		...
		<form @submit="formSubmit">
			<view class="cu-form-group margin-top">
				...
				<input placeholder="两字短标题" name="input1"></input>
			</view>
			<view class="cu-form-group">
				<view class="title">输入框</view>
				<input placeholder="三字标题" name="input2"></input>
			</view>
			<view class="cu-form-group">
				<view class="title">收货地址</view>
				<input placeholder="统一标题的宽度" name="input3"></input>
			</view>
			<view class="cu-form-group">
				<view class="title">收货地址</view>
				<input placeholder="输入框带个图标" name="input4"></input>
				<text class='cuIcon-locationfill text-orange'></text>
			</view>
			<view class="cu-form-group">
				<view class="title">验证码</view>
				<input placeholder="输入框带个按钮" name="input5"></input>
				<button class='cu-btn bg-green shadow'>验证码</button>
			</view>
			<view class="cu-form-group">
				<view class="title">手机号码</view>
				<input placeholder="输入框带标签" name="input6"></input>
			...
			<view class="cu-form-group margin-top">
				...
				<picker @change="PickerChange" :value="index" :range="picker" name="picker1">
					<view class="picker">
			...
			<view class="cu-form-group">
				...
				<picker mode="multiSelector" @change="MultiChange" @columnchange="MultiColumnChange" :value="multiIndex" :range="multiArray" name="picker2">
					<view class="picker">
			...
			<view class="cu-form-group">
				...
				<picker mode="time" :value="time" start="09:01" end="21:01" @change="TimeChange" name="picker3">
					<view class="picker">
						{{time}}
					</view>
				</picker>
			...
			<view class="cu-form-group">
				...
				<picker mode="date" :value="date" start="2015-09-01" end="2020-09-01" @change="DateChange" name="picker4">
					<view class="picker">
						{{date}}
					</view>
				</picker>
			...
			<view class="cu-form-group">
				...
				<picker mode="region" @change="RegionChange" :value="region" name="picker5">
					<view class="picker">
			...
			<view class="cu-form-group padding flex flex-direction">
				<button class="cu-btn bg-grey lg" form-type="submit">提交信息</button>
			</view>
		</form>
	</view>
</template>
	...
	export default {
		...
		methods: {
			formSubmit(e){
				...
				post('member_add',params).then(res=>{
					if(res.code === 1){
